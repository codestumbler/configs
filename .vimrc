...
" vim-ros, for tabcompletion with ROS programs
...
"Enable permanent syntax highlighting when editor supports colors
if &t_Co > 1
   syntax enable
endif

"---------------- Here go my personal changes -------------

" Search down into subfolders
" Provides Tab-completion for all file-related tasks
set path+=**

" Copying to system clipboard, another try
" set clipboard=unnamedplus (somehow doesn't work, or i don't get it)
vnoremap <C-c> "*y
